...
/**
 * Template Name: Default Revise
 * Description: デフォルトテンプレート Revise
 */
?>
        ...
        <div class="item">
          ...
          <div class="bottom-portion">
            ...
            <p class="text">
              ...
              経験がない間はどうしても苦労しがちな、<span class="text--strong">案件の効果的な獲得方法・単価の設定/上げ方</span>などについても1on1で習得していきます。/自治体等から見れるようになりますので、複業活動をより優位に進めやすくなります。
            </p>
          </div>
        </div>
        <div class="item">
...
-->
        ...
        <div class="item-box">
          ...
          <div class="text-portion">
            <div class="top-text">
              ...
              <div class="text-block">
                <p class="name">
                  御堂河内麻衣さん<span class="name--age">（20代/女性）</span>
                </p>
                <p class="career">
  ...
  <section class="movie__section" id="">
    <div class="container">
      ...
      <div class="main-area">
        <div class="movie-box">
          <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/8JseYwXaujc?si=sDewofHZqOkSen3g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
      </div>
      <div id="news"></div>
    </div>
